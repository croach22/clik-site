...
// ── Capability pills ──
const CAPABILITIES = [
  { label: 'Executes the approved plan', icon: '✦' },
  { label: 'On-brand by default', icon: '✦' },
...
export default function FeatureBuild() {
  ...
  return (
    <section ref={sectionRef} id="build-agent" className="relative py-24 md:py-32 px-6 overflow-hidden">
